                  ...
                  <div class="panel-group">
                        <div class="panel panel-default">
                              <div class="panel-heading">
                                <h4 class="panel-title">
                                  <a data-toggle="collapse" href="#collapse1">Core Java</a>
                                    </h4>
                              </div>
                          <div id="collapse1" class="panel-collapse collapse">
                            <div class="panel-body"><a href="">Introduction of Java</a></div>
                            <div class="panel-body"><a href="">OOPS in Java</a></div>
                            <div class="panel-body"><a href="">Inheritance in Java</a></div>
                            <div class="panel-body"><a href="">Encapsuletion of Java</a></div>
                            <div class="panel-footer"><a href="courseview.html">Back to course</a></div>
                          </div>
                    </div>
                 </div>
                 <div id="teststart">
                     <a href="teststart.jsp">Take Test</a>
                 </div>
	     </div>
     </div>
</div>
