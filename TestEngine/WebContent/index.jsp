...
<header id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="images/banner4.jpeg"  width="auto" height="1600">
            <div class="carousel-caption" class="animated rubberBand">
                <h3>Online Exam</h3>
                <p>Give online exam.</p>
            </div>
        </div>
        <div class="item">
            <img src="images/banner_3.jpg"  width="auto" height="1600">
            <div class="carousel-caption" class="animated bounceInLeft">
                <h3>Result</h3>
...
<div class="thumbnails">
  ...
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img src="images/Results-images.jpg" alt="Result" class="img-circle">
      <div class="caption text-center">
        <h3>Results</h3>
        <p>Get your results updates.</p>
      </div>
    </div>
  </div>
  <div class="col-sm-6 col-md-4">
