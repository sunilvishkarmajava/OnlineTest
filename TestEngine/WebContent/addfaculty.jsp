  ...
  <div class="panel panel-default">
   ...
   <div class="panel-heading" role="tab" id="headingtwo">
    ...
    <div id="collapsetwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingtwo">
      <div class="panel-body">
       <ul class="nav-sidebar nav">
        <li><a href="addfaculty.jsp" style="background: gray;">Add Faculty</a></li>
          </ul>
      </div>
  </div>
...
<div class="col-xs-9">
          ...
          <hr>
        <form action="registerTeacherServlet" method="post" enctype="multipart/form-data" class="form-signin" name="ragisterform" onsubmit="return validate();">
             ...
             select Image <input type="file" name="selectedimage">
             </div>
             ...
             <input type="text" id="institute" class="form-control" name="institute" placeholder="Institute Name" required="required"/>
                  <div class="checkbox">
                                    <input type="submit" class="btn btn-primary btn-block btn-large" value="Add"/>
                                     <h2>
                    <% String status="";
