...
app.controller("courseCtrl",function($scope,loginfactory,pageValuefactory){
	//$scope.rolesList=[];
...
<body id="page-top" class="index" ng-app="myApp" ng-controller="courseCtrl" ng-init="init()" >
    <div class="col-xl-12">
      ...
      <div class="panel-body">
       <ul class="nav-sidebar nav">
        <li><a href="facultyviewcourse.jsp"> View Course</a></li>
        	<li><a href="addcontent.jsp" style="background: gray;"> Add Course Content</a></li>
...
<div class="col-xs-9">
          ...
          <div id="mainContent">
          <h2 style="text-align: center;">Add Course Content</h2>
          <hr>
        <form action="addContentServlet" method="post" enctype="multipart/form-data"  class="form-signin formcontent" name="changepwdform" onsubmit="return validate();">
            	<table>
            		<tr>
            		<td><label for="courselist">Course List</label></td>
        			<td><select name="course_id">
        					<option ng-repeat="role in courseList" value="{{role.courseID}}">{{role.title}}</option>
                    </Select>
        			</td></tr>
        		<tr>
            		<tr>
            		<td><label for="ImageUpload">Select File:</label></td>
        			<td><input type="file" value="Browse...." name="uploadimage"/></td></tr>
        		<tr>
            		<td><label for="datalist">Title:</label></td>
        			<td><input id="text" name="coursetitle"/></td></tr>
				<tr>
