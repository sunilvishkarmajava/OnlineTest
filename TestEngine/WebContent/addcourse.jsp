      ...
      <div class="panel-body">
       <ul class="nav-sidebar nav">
        <li><a href="facultyviewcourse.jsp"> View Course</a></li>
        	...
        	<li><a href="addcourse.jsp" style="background-color: gray;"> Add Course</a></li>
          </ul>
      </div>
  </div>
...
<div class="col-xs-9">
          ...
          <hr>
        <form action="courseServlet" method="post" enctype="multipart/form-data" class="form-signin formcontent" name="changepwdform" onsubmit="return validate();">
            	<table>
            		<tr>
