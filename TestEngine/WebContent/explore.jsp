...
<body>
  <div class="row">
   ...
   <div id="banner">
       <img src="images/banner_bg.jpg" alt="banner">
   </div>
    <main class="mainpart">
         <article>
			<h1>About us</h1>
			...
			<p>Online test engine is an educational platform featuring the quickest, simplest way for organizations to train students,         for FREE. The platform features an intuitive, easy-to-use interface to create, deliver and track training of students. 
                ...
                <ul>
                    ...
                    <li>This can be used in educational institutions as well as in corporate world.</li>
                    <li>Can be used anywhere any time as it is a web based application (user Location doesnt matter).</li>
                    <li>No restriction that examiner has to be present when the candidate takes the test.</li>
                </ul>
            </p>
            <p>    
